...
class Mode7:
    ...
    def update(self):
        ...
        self.screen_array = self.render_frame(self.floor_array, self.ceil_array, self.screen_array,
                                              self.tex_size, self.angle, self.pos, self.alt, self.index)
    ...
    def render_frame(floor_array, ceil_array, screen_array, tex_size, angle, player_pos, alt, index):
        ...
        for i in prange(WIDTH):
            ...
            for j in range(HALF_HEIGHT, HEIGHT):
                ...
                # ceil pos and color
                ceil_pos = int((ceil_x+index) * SCALE % tex_size[0]), int(ceil_y * SCALE % tex_size[1])
